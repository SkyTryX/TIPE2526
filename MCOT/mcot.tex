...
\section{Intro}
\begin{itemize}
    \item \textbf{Titre: }Etude de la Méthode des tableaux: Application en logique propositionelle et en logique linéaire temporelle
...
C'est ainsi qu'une grande problématique dans le domaine de la logique (en outre la logique propositionnelle) est la
...
résoudre ce problème en temps exponentiel en la taille de la formule étudiée. Nous nous intéressons notamment à la 
...
toutes les branches. Si c'est le cas, la formule est insatisfaisable. Le but de notre étude n'est évidemment pas de
...
ce n'est pas possible, nous trouverons des moyens d'optimiser l'algorithme exponentiel [2].
...
méthode des tableaux dans la logique linéaire temporelle, tout en proposant un exemple d'objet technique pouvant correspondre
à une telle formule.
