...
\begin{frame}{Alternée - Conversion}
    ...
    \begin{itemize}
        \item Quand on traduit une forme alternée, on obtient une FNC dont la taille des monomes est strictement croissante.
        ...
        \item En convertissant toutes les formules en FNC, seules certaines formules ayant des clauses à taille croissante.
    \end{itemize}
\end{frame}
