...
\author{GIL Dorian}
\subtitle{Etude de la Méthode des tableaux: Application en logique propositionelle et en logique linéaire temporelle}
\date{}
...
\begin{frame}{Etude}
    Nous allons nous interesser aux applications de la méthode des tableaux dans le bon fonctionnement d'un Mutex.
\end{frame}
