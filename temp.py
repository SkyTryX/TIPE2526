...
def two_sat_solver(two_cnf_formula):
    ...
    return find_contradiction(strongly_connected_components(graph))
...
for a in ["a1","a2", "a3", "a4", "~a1","~a2", "~a3", "~a4"]:
    for b in ["a1","a2", "a3", "a4", "~a1","~a2", "~a3", "~a4"]:
        for c in ["a1","a2", "a3", "a4", "~a1","~a2", "~a3", "~a4"]:
            for d in ["a1","a2", "a3", "a4", "~a1","~a2", "~a3", "~a4"]:
                formula = two_cnf()
