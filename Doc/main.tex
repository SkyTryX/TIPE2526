...
\subsection{Méthode des tableaux}
Adapter une ancienne implémentation (en rajoutant les elements de LTL)

\subsection{Automates de Büchi}
\subsubsection{Implémentation de base}
Càd fonction de base des Automates de Büchi, produit de deux autommtes, montrer qu'un automate de Büchi est vide.

\subsubsection{Algorithme de Gerth}
Gerth et al. 1995 (on-the-fly) utilise la méthode des tableaux

\subsubsection{Traduction GBA > BA}
...


\section{Application}

\subsection{A la méthode des tableaux}
...

\subsection{Aux automates de Büchi}
...

\subsection{Comparaison pratique}
...
...
\begin{enumerate}
    ...
    \item Algorithmes pour la vérification de formules LTL par l'approche automate
Alexandre DURET-LUTZ
\end{enumerate}
(1) Notation Logique (2) Méthode des tableaux LP (3) Méthode des tableaux LTL (4) Model Checking

Noté Bibliographie pour Buchi
\end{document}