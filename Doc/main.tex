...
\section*{Model Checking et LTL: Application et comparaison des automates de Büchi et de la méthode des tableaux}
...
\subsection{Résumé}
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item Comparaison dans un exemple du model checking en terme de rapidité et compléxité (théorique et pratique)
    \end{enumerate}
